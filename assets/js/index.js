function enviarMensaje() {
    ...
    if(vacio == false){
        ...
        document.getElementById("respuesta").innerHTML = `<h2>Muchas gracias por tu mensaje <span>${nombre}</span>! Enviaremos una respuesta en breves a <span>${correo}</span>.</h2>`;
